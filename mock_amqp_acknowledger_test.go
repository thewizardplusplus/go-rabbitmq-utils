...
// MockAMQPAcknowledger is an autogenerated mock type for the AMQPAcknowledger type
type MockAMQPAcknowledger struct {
	mock.Mock
}

// Ack provides a mock function with given fields: tag, multiple
func (_m *MockAMQPAcknowledger) Ack(tag uint64, multiple bool) error {
...
func (_m *MockAMQPAcknowledger) Nack(tag uint64, multiple bool, requeue bool) error {
...
func (_m *MockAMQPAcknowledger) Reject(tag uint64, requeue bool) error {
